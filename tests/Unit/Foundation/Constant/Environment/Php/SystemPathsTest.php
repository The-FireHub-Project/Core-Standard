...
use FireHub\Core\Foundation\Constant\Environment\Php\SystemPaths;
...
final class SystemPathsTest extends FireHubTestCase {
     ...
     * @return void
     */
    #[TestWith([PHP_LOCALSTATEDIR, SystemPaths::LOCAL_STATE])]
    #[TestWith([PHP_DATADIR, SystemPaths::DATA])]
    ...
    public function testCannotBeInstantiated ():void {
        ...
        $ref = new ReflectionClass(SystemPaths::class);
