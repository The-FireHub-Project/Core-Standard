...
abstract class StrSafe {
     ...
     *
     * @return ($string is empty ? '' : non-empty-string) the Stripped string.
     *
     ...
     * </p>
     *
     * @return ($string is empty ? '' : non-empty-string) String with backslashes stripped off.
     *
    ...
    final public static function explode (string $string, string $separator, int $limit = MAX):array {
        ...
        try {
            ...
            throw new EmptySeparatorException()->fromString($string);
     ...
     * </p>
     *
     * @return ($string is empty ? '' : non-empty-string) The translated string.
     */
