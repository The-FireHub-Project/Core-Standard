...
use FireHub\Core\Support\Exceptions\Constant\ {
    FailedToDefineException, NotDefinedException
};
use Error;
...
final class Constant {
     ...
     * </p>
     *
     * @throws \FireHub\Core\Support\Exceptions\Constant\NotDefinedException If the constant is not defined.
     *
    ...
    public static function value (string $name):mixed {
        ...
        try {
            ...
            throw new NotDefinedException()->withName($name);
