...
use FireHub\Core\Support\Enums\ {
    String\CaseFolding, String\Encoding, Side
};
use FireHub\Core\Support\Exceptions\EncodingException;
...
final class StrMB extends StrSafe {
     ...
     * </p>
     * @param \FireHub\Core\Support\Enums\String\CaseFolding $case_folding <p>
     ...
     * </p>
     *
     * @return ($string is empty ? '' : non-empty-string) The portion of string specified by the start and length
     * parameters.
     */
     ...
     * </p>
     *
     * @return ($string is empty ? '' : non-empty-string)|false The portion of string or false if the needle
     * is not found.
     */
    ...
    public static function encoding (?Encoding $encoding = null):true|Encoding {
        ...
        return $encoding
            ...
            : (($new_encoding = Encoding::tryFrom(mb_internal_encoding()))
                ? $new_encoding : throw new EncodingException()->withMessage("Couldn't get current encoding."));
