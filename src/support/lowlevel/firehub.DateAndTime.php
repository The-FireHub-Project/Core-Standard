...
use FireHub\Core\Support\Exceptions\DateTime\ {
    FailedToFormatTimestampAsIntException, FailedToGetMicrotimeException, StringToTimestampException,
    ParseFromFormatException
};
...
final class DateAndTime {
     ...
     * </p>
     *
     * @return ($gmt is true ? string : non-falsy-string) String formatted according to the given format string using
     * the given integer timestamp.
     *
    ...
    public static function get (?int $timestamp = null):array {
        ...
        $get_date['dts'] = localtime($timestamp, true)['tm_isdst']; // @phpstan-ignore offsetAccess.notFound
