...
/**
 * ### Provides an immutable floating-point value object with a high-level developer API
 *
 * The Float class represents a floating-point value within the FireHub Foundation layer.
 *
 ...
 * floating-point values to be used consistently across the FireHub ecosystem.
 *
 * This class is responsible for high-level floating-point operations and developer experience, while low-level numeric
 ...
 */
abstract readonly class Decimal extends Number {
